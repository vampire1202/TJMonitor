...
namespace TJMonitor.DAL
{
    ...
    public partial class CarConfigDis
    {
        ...
        public int GetMaxId()
        {
            return DbHelperOleDb.GetMaxID("id", "CarConfigDis");
        }
        ...
        public bool Exists(int id)
        {
            ...
            strSql.Append("select count(1) from CarConfigDis");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into CarConfigDis(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update CarConfigDis set ");
            ...
            parameters[0].Value = model.underPic;
        ...
        public bool Delete(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from CarConfigDis ");
            strSql.Append(" where id=@id ");
            OleDbParameter[] parameters = {
					new OleDbParameter("@id", OleDbType.Integer,4)			};
            parameters[0].Value = id;
        ...
        public TJMonitor.Model.CarConfigDis GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select [id],firstLetter,brand,carSeries,saleStatus,seriesName,modelYear,[price],exhaust,manufacturer,leval,engine,transmissionBox,[size],structure,maxSpeed,official0to100,actual0to100,actualBrake,actual,oilconsumption,groundClearance,minGroundClearance,warranty,[length],[width],[height],wheelbase,frontTrack,rearWheel,[weigh],cardoors,carseats,tankVolume,trunkVolume,engineModel,MaxPs,maxP,maxPRpm,maxTorque,maxRpm,gears,transmissionBoxMode,frontSuspension,backSuspension,helpStyle,carStructure,frontTireSize,backTireSize,spareTireSize,appearanceColor,appearanceColorCode,innerColor,innerColorCode,packingBoxSize,underPic from CarConfigDis ");
            strSql.Append(" where id=@id ");
            OleDbParameter[] parameters = {
					new OleDbParameter("@id", OleDbType.Integer,4)			};
            parameters[0].Value = id;

            TJMonitor.Model.CarConfigDis model = new TJMonitor.Model.CarConfigDis();
        ...
        /// 得到一个对象实体
        /// </summary>
        public TJMonitor.Model.CarConfigDis DataRowToModel(DataRow row)
        {
            TJMonitor.Model.CarConfigDis model = new TJMonitor.Model.CarConfigDis();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select [id],firstLetter,brand,carSeries,saleStatus,seriesName,modelYear,price,exhaust,manufacturer,leval,engine,transmissionBox,[size],structure,maxSpeed,official0to100,actual0to100,actualBrake,actual,oilconsumption,groundClearance,minGroundClearance,warranty,[length],[width],[height],wheelbase,frontTrack,rearWheel,[weigh],cardoors,carseats,tankVolume,trunkVolume,engineModel,MaxPs,maxP,maxPRpm,maxTorque,maxRpm,gears,transmissionBoxMode,frontSuspension,backSuspension,helpStyle,carStructure,frontTireSize,backTireSize,spareTireSize,appearanceColor,appearanceColorCode,innerColor,innerColorCode,packingBoxSize,underPic ");
            strSql.Append(" FROM CarConfigDis ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Distinct "+strField);
            strSql.Append(" FROM CarConfigDis ");
            return DbHelperOleDb.Query(strSql.ToString());
        }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from CarConfigDis T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "CarConfigDis";
